...
# Add 'Games' to your existing folders
gsettings set org.gnome.desktop.app-folders folder-children "['System', 'Utilities', 'Games']"

# Configure the Games folder to include all apps with Game category
